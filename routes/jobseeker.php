...
Route::middleware('role:jobseeker')->group(function () {
    ...
    Route::post('/settings/jobseeker/analyze-cv', [JobSeekerController::class, 'analyzeCv'])->name('jobseeker.analyze-cv');
    Route::post('/settings/jobseeker/apply-cv', [JobSeekerController::class, 'applyCv'])->name('jobseeker.apply-cv');
    Route::delete('/settings/jobseeker/cv-file', [JobSeekerController::class, 'deleteCvFile'])->name('jobseeker.cv-file.delete');
    ...
    Route::post('/vacancies/{vacancy}/quick-apply', [VacancyController::class, 'quickApply'])->name('vacancies.quick-apply');
